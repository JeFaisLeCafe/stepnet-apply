...
pilot = Driver.create!(user: user, firstname: "James", lastname: "Bond", phone: "06 01 23 45 78", company: my_company)
...
pilot = Driver.create!(user: user, firstname: "Elon", lastname: "Musk", phone: "06 01 23 45 90", company: my_company)
puts "#{pilot.firstname} pilot created!"
